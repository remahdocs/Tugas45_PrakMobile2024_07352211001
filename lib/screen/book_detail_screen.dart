import 'package:bab5/screen/edit_book_screen.dart';
import 'package:bab5/services/api_service.dart';
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    try {
                      await deleteBook(
                          book.id); // Panggil API untuk menghapus buku
                      Navigator.pop(
                          context, book.id); // Kirim ID buku yang dihapus
                    } catch (e) {
